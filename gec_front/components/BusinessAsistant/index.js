      ...
      <div className="container">
        ...
        >
          <div className="__selector-box_01">
            <SectionTitle
              titleText="Your business assistant"
              titleColor="#1E2E38"
              className="business_assistant-title"
            />
            <div className="questions-number-box">
              ...
              <div className="text-box_1">
                Answering the question below will help us to provide
                personalized content related to your business needs and
                challenges.
              </div>
            </div>
            ...
            <div className="item-form-box">
              ...
              >
                <SelectItem
                  check={checkCount}
                  itemTitle="Organizational/Management Efficiency"
                />
                <SelectItem check={checkCount} itemTitle="Data Analytics" />
                <SelectItem
                  check={checkCount}
                  itemTitle="costumer experience"
                />
                <SelectItem check={checkCount} itemTitle="Data Analytics" />
                <SelectItem
                  check={checkCount}
                  itemTitle="New Business Development"
                />
                <SelectItem check={checkCount} itemTitle="Data Analytics" />
                <SelectItem
                  check={checkCount}
              ...
              <div className="select-buttons">
                <div className="left-show-all">
                  <h3 onClick={handleShowItems}>Show All</h3>
                </div>
                <div className="next-question-btn">
                  <div
                    className={`next-btn ${count > 0 ? "active-btn" : ""}`}
          ...
          <div className="__selector-box_02">
            ...
            <div className="questions-number-box">
              <div className="title-box_1">
                <div
                  className="circle"
                  style={{ background: "rgba(4,152,120,0.15)" }}
                ></div>
                <div className="title">
                  <h2 style={{ color: "#049878" }}>
                    Select Your Business Needs
                  </h2>
                  <div className="question-num">
                    <h4>Question</h4>
                    <span className="_n_1" style={{ color: "#049878" }}>
                      2
                    </span>
                    <h4>Of</h4>
                    <span className="_n_2">2</span>
            ...
            <div className="item-form-box">
              ...
              <div className="select-buttons">
                ...
                <div className="next-question-btn next-question-btn_2">
                  ...
                  <button className="apply-btn__">apply</button>
                </div>
              </div>
            </div>
          </div>
